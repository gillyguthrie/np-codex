...
- **native-fatigue-regen**: Characters natively regenerate 5% of max fatigue every 6-second tick — from the community's most authoritative mechanics voice: 'you regen based on totals too so every 100 HP/MP/Fatigue also = +5 hot/mot/fot' (2025-03-23, public channel). The same statement covers HP (independently attested at 5%, 2026-08-16 — cross-corroboration). Stunted Magicka (Atronach) deletes base regen (2026-08-21).
