...
- **native-hp-regen** **[contested]**: CONTESTED — probably NO native HP regen. The maintainer (a daily player) has never observed universal native HP regeneration (ruled 2026-08-26). The two archive quotes that once suggested a native 5%-of-max rate ('you regen 5% of your max every 6sec', 2026-08-16; 'every 100 HP/MP/Fatigue also = +5 hot/mot/fot', 2025-03-23) sit in threads about CM picks and FoT item values — they most plausibly describe pool-scaled regen from specific SOURCES, not a baseline every character has. Treat as: no native HP regen unless a controlled in-game reading shows otherwise.
...
- **native-fatigue-regen** **[contested]**: CONTESTED — probably NO native fatigue regen (maintainer-ruled 2026-08-26, same reasoning and same source quotes as fact:native-hp-regen). Briefly encoded as 5% of max per tick (v0.4.33) from the 2025-03-23 quote; withdrawn the same day on maintainer review. Treat as: no native fatigue regen pending a controlled in-game timing check.
